...
\begin{document}
  ...
  \cvitem{}{\textbf{Vandal, T.}, Rameau, J., Doyon, R. \textit{Dynamical Mass Estimates of the $\beta$ Pictoris Planetary System through Gaussian Process Stellar Activity Modeling.} 2020, \href{https://doi.org/10.3847/1538-3881/abba30}{AJ, 160, 243}.}
  \cvitem{}{Desli\`eres, A. et al. (incluant \textbf{Vandal, T.}). \textit{The Gl 229 System Revisited with the Line-by-line Framework: Planetary Signals Now Appear as Stellar Activity Ghosts}. 2025, \href{https://ui.adsabs.harvard.edu/abs/2025AJ....169..182D}{AJ, 169, 182}.}
  \cvitem{}{Albert, L. et al. (incluant \textbf{Vandal, T.}). \textit{JWST 1.5 {\ensuremath{\mu}}m and 4.8 {\ensuremath{\mu}}m Photometry of Y Dwarfs}. 2025, \href{https://ui.adsabs.harvard.edu/abs/2025AJ....169..163A}{AJ, 169, 163}.}
  \cvitem{}{Blakely, D. et al. (incluant \textbf{Vandal, T.}). \textit{The James Webb Interferometer: Space-based Interferometric Detections of PDS 70 b and c at 4.8 {\ensuremath{\mu}}m}. 2025, \href{https://ui.adsabs.harvard.edu/abs/2025AJ....169..137B}{AJ, 169, 137}.}
  \cvitem{}{Cooper, R. et al. (incluant \textbf{Vandal, T.}). \textit{Commissioning and calibration of the JWST aperture masking interferometry mode}. 2024, \href{https://ui.adsabs.harvard.edu/abs/2024SPIE13095E..2RC}{SPIE Astronomical Telescopes and Instrumentation}.}
  \cvitem{}{Malo, L. et al. (incluant \textbf{Vandal, T.}). \textit{NIRPS near-infrared spectrograph: AITV phase at ESO3.6m/La Silla}. 2024, \href{https://ui.adsabs.harvard.edu/abs/2024SPIE13096E..46M}{SPIE Astronomical Telescopes and Instrumentation}.}
  \cvitem{}{Artigau, \'E. et al. (incluant \textbf{Vandal, T.}). \textit{NIRPS first light and early science: breaking the 1 m/s RV precision barrier at infrared wavelengths}. 2024, \href{https://ui.adsabs.harvard.edu/abs/2024SPIE13096E..0CA}{SPIE Astronomical Telescopes and Instrumentation}.}
  \cvitem{}{Jahandar, F. et al. (incluant \textbf{Vandal, T.}). \textit{Comprehensive High-resolution Chemical Spectroscopy of Barnard's Star with SPIRou}. 2024, \href{https://ui.adsabs.harvard.edu/abs/2024ApJ...966...56J}{ApJ, 966, 56}.}
  \cvitem{}{Moutou, C. et al. (incluant \textbf{Vandal, T.}). \textit{Characterizing planetary systems with SPIRou: M-dwarf planet-search survey and the multiplanet systems GJ 876 and GJ 1148}. 2023, \href{https://ui.adsabs.harvard.edu/abs/2023A&A...678A.207M}{A\&A, 678, A207}.}
  \cvitem{}{Doyon, R. et al. (incluant \textbf{Vandal, T.}). \textit{The Near Infrared Imager and Slitless Spectrograph for the James Webb Space Telescope. I. Instrument Overview and In-flight Performance}. 2023, \href{https://ui.adsabs.harvard.edu/abs/2023PASP..135i8001D}{PASP, 135, 098001}.}
  \cvitem{}{Calissendorff, P. et al. (incluant \textbf{Vandal, T.}). \textit{JWST/NIRCam Discovery of the First Y+Y Brown Dwarf Binary: WISE J033605.05-014350.4}. 2023, \href{https://ui.adsabs.harvard.edu/abs/2023ApJ...947L..30C}{ApJ, 937, L30}.}
  \cvitem{}{Sivaramakrishnan, A. et al. (incluant \textbf{Vandal, T.}). \textit{The Near Infrared Imager and Slitless Spectrograph for the James Webb Space Telescope -- IV. Aperture Masking Interferometry}. 2022, \href{https://ui.adsabs.harvard.edu/abs/2022arXiv221017434S/abstract}{PASP, 135, 014502}.}
  \cvitem{}{Kammerer, J., Cooper, R., \textbf{Vandal, T.} et al. \textit{The Near Infrared Imager and Slitless Spectrograph for JWST -- V. Kernel Phase Imaging and Data Analysis}. 2022, \href{https://ui.adsabs.harvard.edu/abs/2022arXiv221017528K/abstract}{PASP, 135, 014502}.}
  \cvitem{}{Kammerer, J. et al. (incluant \textbf{Vandal, T.}). \textit{Performance of near-infrared high-contrast imaging methods with JWST from commissioning}. 2022, \href{https://ui.adsabs.harvard.edu/abs/2022SPIE12180E..3NK/abstract}{SPIE Astronomical Telescopes and Instrumentation}.}
  \cvitem{}{Cadieux, C. et al. (incluant \textbf{Vandal, T.}). \textit{TOI-1452 b: SPIRou and TESS reveal a super-Earth in a temperate orbit transiting an M4 dwarf}. 2022, \href{https://ui.adsabs.harvard.edu/abs/2022AJ....164...96C/abstract}{AJ, 164, 96}.}
  \cvitem{}{Artigau, É et al. (incluant \textbf{Vandal, T.}). \textit{Line-by-line Velocity Measurements: an Outlier-resistant Method for Precision Velocimetry}. 2022, \href{https://ui.adsabs.harvard.edu/abs/2022AJ....164...84A/abstract}{AJ, 164 84}.}
  \cvitem{}{Martioli, E. et al. (incluant \textbf{Vandal, T.}). \textit{TOI-1759 b: A transiting sub-Neptune around a low mass star characterized with SPIRou and TESS}. 2022, \href{https://ui.adsabs.harvard.edu/abs/2022A\%26A...660A..86M/abstract}{A\&A, 660, A86}.}
  \cvitem{}{Artigau, É et al. (incluant \textbf{Vandal, T.}). \textit{TOI-1278 B: SPIRou unveils a rare Brown Dwarf Companion in Close-In Orbit around an M dwarf.}. 2021, \href{https://ui.adsabs.harvard.edu/abs/2021arXiv210604536A/abstract}{AJ, 162, 144}.}
  \cvitem{}{Pelletier, S et al. (incluant \textbf{Vandal, T.}). \textit{Where is the Water? Jupiter-like C/H ratio but strong H$_{2}$O depletion found on $\tau$
  Boötis b using SPIRou.} 2021, \href{https://ui.adsabs.harvard.edu/abs/2021arXiv210510513P/abstract}{AJ, 162, 73}.}
...
\section{Enseignement et tutorat}
...
\subsection{\langfr{Participation à des conférences}\langen{Conferences and workshosp}}
...
\cventry{2023}{Flatiron Institute}{Dot Astronomy 12}{New-York}{}{Workshop in an "unconference" format about the use of modern computing facilities and software in astronomy}
...
\cventry{2020-2022}{\langen{Canadian Astronomical Society (CASCA)}\langfr{Société canadienne d'astronomie (CASCA)}}{Rencontre annuelle de la CASCA}{En ligne}{}{}
...
\subsection{Communication scientifique et science citoyenne}
\cventry{2022-2025}{\irex}{Journées carrières de l'IREx}{Montréal}{\langen{Volunteer}\langfr{Bénévole}}{\langen{Presentation and discussion with high-school students}\langfr{Présentation et discussion avec des jeunes du secondaires et du cégep visitant l'institut.}}
...
% TODO: Other years?
\cventry{2021}{\irex}{Grande conférence de l'IREx 2021}{Montréal}{Bénévole}{Accueil du public et participation au segment questions-réponses à la fin de la conférence}
...
\cventry{2021-...}{\irex \langen{and}\langfr{et}}{Présentations \textit{Ma vie de chercheur en astronomie}}{Montréal}{}{{\normalsize \textit{Regroupement des cégeps de Montréal (programme acceScience), Conférencier}}\newline 5 présentations}
...
\cventry{2020-...}{Coeur des sciences, Université du Québec à Montréal}{Sprint de sciences}{Montréal}{\langen{Speaker}\langfr{Conférencier}}{\langen{Interactive conference about exoplanets for high-schools}\langfr{Atelier interactif sur les exoplanètes au secondaire}, \langen{approximately}{environ} 10 \langen{per semester}\langfr{par session}}
...
\cventry{2020 \langen{and}\langfr{et} 2021}{\langen{Center for research in astrophysics of Quebec (CRAQ)}\langfr{Centre de recherche en astrophysique du Québec (CRAQ)}}{\langen{CRAQ Calendar}\langfr{Calendrier du CRAQ}}{Montréal}{\langen{Volunteer}\langfr{Bénévole}}{\langen{Description translation and management of the distribution list}\langfr{Traduction de textes et mise à jour de la liste de distribution}}
% TODO: Was there one after that? Eclipse?
\cventry{2018 \langen{and}\langfr{et} 2019}{Université de Montréal}{AstroMIL: Journée d'astronomie du Campus MIL}{Montréal}{\langen{Volunteer}\langfr{Bénévole}}{}
...
% TODO: Update how money is displayed in english
\section{\langen{Awards \& Recognitions}\langfr{Prix, bourses et mentions}}
\subsection{Université de Montréal}
\cventry{2022}{Études supérieures et postdoctorales (ESP), Université de Montréal}{Bourse d'excellence des ESP - Bourse Alma Mater\langen{ (ESP Excellence Scholarship - Alma Mater)}}{}{\money{10000}}{}
